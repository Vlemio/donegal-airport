...
export default defineConfig({
  ...
  // NOTE: old-site → new-site 301s (donegalairport.ie migration) live in
  // src/data/legacy-redirects.ts + src/pages/[...oldPath].astro /
  // src/pages/ga/[...oldPath].astro, NOT in Astro's own `redirects` config
  // here. That's deliberate — see the long comment at the top of
  // legacy-redirects.ts for the reproducible build bug that ruled it out
  // (multiple old URLs redirecting to the same destination page crashes
  // the SSR entrypoint build step).
